...
$tablestudents = "SELECT * FROM Student_Accounts INNER JOIN Courses ON Student_Accounts.Course_ID = Courses.Course_ID WHERE Account_Type='Student' AND Student_Accounts.Course_ID = '$courses' ORDER BY ReferenceNo";
        ...
        <div class="col-sm-2">
            ...
            <div class="col-sm-10">
                <div class="page-title">
                    ...
                    <a href="manage-student-courses.php"><button class="go-back-btn">GO BACK</button></a>
                </div>
                    ...
                    <table>
                        ...
                        <?php
                            if(isset($_POST['search'])){
                                $search = $_POST['search'];
                                $finder = "SELECT * FROM Student_Accounts INNER JOIN Courses ON Student_Accounts.Course_ID = Courses.Course_ID WHERE Student_Accounts.Course_ID = '$courses' AND FirstName LIKE '$search%' OR LastName LIKE '$search%'";
